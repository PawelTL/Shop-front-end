...
function Store({ products, loadProducts }) {
  ...
  return (
    <motion.div
      className='w-screen bg-white mt-[9vh] pb-[9vh]'
      initial={{ width: 0 }}
      animate={{ width: "100vw" }}
      exit={{ x: window.innerWidth, transition: { duration: 0.1 } }}>

      <h1 className='px-16 py-3 text-5xl font-semibold'>Jewelery</h1>
      ...
      <h1 className='px-16 py-3 text-5xl font-semibold'>Electronics</h1>
      <div className='flex justify-start w-full gap-4 px-10 pb-4'>
      ...
      <h1 className='px-16 py-3 text-5xl font-semibold'>Men's Clothing</h1>
      <div className='flex justify-start w-full gap-4 px-10 pb-4'>
      ...
      <h1 className='px-16 py-3 text-5xl font-semibold'>Women's Clothing</h1>
      <div className='flex justify-start w-full gap-4 px-10 pb-4'>
